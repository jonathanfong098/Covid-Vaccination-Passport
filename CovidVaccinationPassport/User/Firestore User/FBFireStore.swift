...
enum FBFirestore {
    ...
    static func retrieveFBUser(uid: String, completion: @escaping (Result<FBUser, Error>) -> ()) {
        let reference = Firestore
            ...
            .document(uid)
        getUserDocument(for: reference) { (result) in
            switch result {
    ...
    fileprivate static func getUserDocument(for reference: DocumentReference, completion: @escaping (Result<[String : Any], Error>) -> ()) {
