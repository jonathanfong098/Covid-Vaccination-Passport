...
//            Spacer()
            ...
            Button(action: {
                FBPatient.buildPatient(id: self.patient.id, name: self.patient.name, age: self.patient.age, location: self.patient.location, nurseSignature: self.patient.nurseSignature , haveFirstVaccine: self.patient.firstVaccineStatus, haveSecondVaccine: self.patient.secondVaccineStatus)
            }, label: {
                Text("Button")
            })
        ...
        }.background(Color.salmonColor).ignoresSafeArea()
